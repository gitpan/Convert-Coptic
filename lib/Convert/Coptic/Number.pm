...
Convert::Coptic::Number - Convert Between Western and Coptic Numeral Systems
...
=head1 SYNOPSIS
 ...
 #
 my $n = new Convert::Coptic::Number ( 12345 );
...
The package is known to work on Perl 5.6.1 and has not been tested on
